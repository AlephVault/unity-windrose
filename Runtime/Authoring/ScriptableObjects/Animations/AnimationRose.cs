    ...
    namespace Authoring
    {
        namespace ScriptableObjects
        {
            namespace VisualResources
            {
                ...
                /// </summary>
                [CreateAssetMenu(fileName = "NewAnimationRose", menuName = "Aleph Vault/WindRose/Visual Resources/Animation Rose", order = 201)]
                public class AnimationRose : ScriptableObject
                {
...
#if UNITY_EDITOR
                    [MenuItem("Assets/Create/Aleph Vault/WindRose/Visual Resources/Animation Rose (with Moving animations)")]
                    ...
                    [MenuItem("Assets/Create/Aleph Vault/WindRose/Visual Resources/Animation Rose (with Staying animations)")]
                    ...
                    [MenuItem("Assets/Create/Aleph Vault/WindRose/Visual Resources/Animation Rose (with empty animations)")]
